        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building scalable full-stack web applications with modern frameworks, REST APIs, and responsive user interfaces.
              </p>
          ...
          >
            ...
            <div className="what-corner"></div>
            <div className="what-content-in">
              <h3>AI & PROBLEM SOLVING</h3>
              <h4>Core CS & AI</h4>
              <p>
                Strong foundation in DSA, core CS subjects, and experience building AI-powered applications with modern LLM tools.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">DSA</div>
                <div className="what-tags">DBMS</div>
                <div className="what-tags">OS</div>
                <div className="what-tags">Computer Networks</div>
                <div className="what-tags">Prompt Engineering</div>
                <div className="what-tags">Machine Learning</div>
                <div className="what-tags">LLM Tools</div>
